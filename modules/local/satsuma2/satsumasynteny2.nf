...
process SATSUMA2_SATSUMASYNTENY2 {
    ...
    conda (params.enable_conda ? "bioconda::satsuma2=20161123" : null)
    ...
    tuple val(meta),path($satsuma_chain_chunk), emit: chain
    ...
    satsuma_chain_chunk = meta.id + "-" + meta_t.id + ".satsuma_summary.chained.out"
